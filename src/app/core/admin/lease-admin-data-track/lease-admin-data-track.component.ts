...
@Component({
  selector: "app-lease-admin-data-track",
  templateUrl: "./lease-admin-data-track.component.html",
  styleUrls: ["./lease-admin-data-track.component.scss"],
  providers: [
    { provide: CarouselConfig, useValue: { interval: 1500, noPause: true, showIndicators: true, isAnimated: true } }
  ]
})
export class LeaseAdminDataTrackComponent implements OnInit {
  // Chart
  private chart1: any;
  private chart2: any;
  private chart3: any;
